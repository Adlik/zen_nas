...
# pylint: disable=import-error,function-redefined,too-many-arguments
import os
import os.path
import sys
...
def make_dataset(dir_path, class_to_idx, extensions=None, is_valid_file=None):
    images = []
    ...
    if extensions is not None:
        def is_valid_file(file_path):
            return has_file_allowed_extension(file_path, extensions)
...
class DatasetFolder(VisionDataset):
    ...
    def _find_classes(self, dir_path):
        ...
        Returns:
            tuple: (classes, class_to_idx) where classes are relative to (dir_path), and class_to_idx is a dictionary.
