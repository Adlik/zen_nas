...
if __name__ == '__main__':
    ...
    with torch.no_grad():
        for i, (input, target) in enumerate(val_loader):
            ...
            # student_stage_features_list, student_logit = model.extract_stage_features_and_logit(input, target_downsample_ratio=16)
            # print(student_stage_features_list[0].shape)
            # break
            output = model(input)
